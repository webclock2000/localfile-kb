...
> **日期**: 2026-06-19  
> **状态**: 设计参考文档  
> **⚠️ 重要提示**: 本文件是 v0.1.0 初版设计文档。在后续开发部署中部分细节已调整——**代码和 `pyproject.toml` 是最终事实来源**。详见 [README.md](README.md) 中的差异表。架构决策 (ADR §3)、数据模型 (§5)、prompt 工程 (§8)、中文抽取方案 (§9)、可靠性设计 (§10)、个性化 (§11)、API 规范 (§12)、测试策略 (§14) 仍然是有效的设计参考。
>
